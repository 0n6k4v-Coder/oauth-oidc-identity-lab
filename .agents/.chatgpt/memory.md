...
3. You Must attached all of standards references you use to write lecture.
4. You must not write it precisely not generated something it unnecessarily in explain do not write it so much item cuz you looking at the own pattern but you must consider number of item that really suit for lecture content.
```